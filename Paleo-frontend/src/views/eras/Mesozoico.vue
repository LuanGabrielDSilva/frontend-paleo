...
const MESOZOICO_ID = "c94ec701-7811-4e0e-b6ee-d3359aefb2ed";

onMounted(async () => {
  try {
    const res = await api.get("/periodos");
    periodos.value = res.data.filter(
      (p: any) => p.eraId === MESOZOICO_ID
    );
  } catch (err) {
  ...
  <div class="page">
    ...
    <section class="content">
      ...
      <div class="prose">
        ...
        <p>
          Durante esse tempo surgiram gigantes como o Argentinosaurus, predadores ferozes como o Tyrannosaurus rex, 
          e os primeiros pássaros — descendentes diretos dos dinossauros terópodes.
        </p>
        <p>
          ...
          <div class="era-grid">
            ...
            <div class="era-gallery">
              <div class="era-img-main">
                <img
                  v-if="activePeriodo.image"
                  :src="activePeriodo.image"
                  :alt="activePeriodo.name"
                />
...
.expand-enter-from,
.expand-leave-to {
  opacity: 0; transform: translateY(-16px); max-height: 0;
}
.expand-enter-to,
.expand-leave-from {
